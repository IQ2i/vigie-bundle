...
// Imported only when iq2i_vigie.threat.enabled is true, so ThreatDecisionStoreInterface is
// always a valid reference here. Most arguments below are placeholders, overridden by loadThreatExtension().
