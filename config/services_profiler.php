...
/*
 * Loaded only when kernel.debug is true and symfony/web-profiler-bundle is installed.
 * $httpEnabled/$recordedPaths/$ignoredPaths below are overridden from iq2i_vigie.http.*.
 */
