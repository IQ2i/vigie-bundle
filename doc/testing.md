...
`IQ2i\VigieBundle\Test` lets an application assert that a request recorded a given activity, without a
database and without depending on the bundle's internals.
...
it works from any test case, or none at all:
