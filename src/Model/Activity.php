...
final readonly class Activity
{
     ...
     *                                      scalar or null is silently dropped
     */
    public function __construct(
        ...
        // An empty string groups with "no value", not with itself as a bogus subject.
    ...
    /**
     * A business-defined activity: an export, a payment, a role change.
     * $action is a short, free-form label, by convention `^[a-z0-9_.:-]+$`
     * (e.g. "export.completed").
     *
     * @param array<string, scalar|null> $context
     */
