 ...
 * interface plus a service id to point `iq2i_vigie.threat.provider` at.
 */
interface ThreatProviderInterface
{
    /**
     * Short, stable identifier of the SIEM this provider talks to ("crowdsec"), stamped on every ThreatDecision it produces.
     */
