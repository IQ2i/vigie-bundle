 ...
 * boundaries, mapping an IPv4 address into the IPv4-mapped IPv6 range so
 * both compare byte-for-byte the same way.
 *
 * @internal
 */
final class IpRange
{
    ...
    public static function parse(string $value): ?array
    {
        ...
        // Not "contains a dot": an IPv4-mapped IPv6 address has dots too, but its prefix counts over 128 bits.
        ...
        // An IPv4-mapped address only varies over its last 32 bits, so a "/24" fixes the top 120 bits.
