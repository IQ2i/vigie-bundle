 ...
 *
 * @api not @internal: an application maintaining its own lookup column (an
 *      indexed hash of a user's identifier, to find the user behind a
 *      decision, see doc/remediation.md) computes it with this class,
 *      autowireable, rather than with Pseudonymizer, which is @internal.
 */
final readonly class QueryNormalizer
{
    ...
    /**
     * sessionId is always hashed when recorded.
     */
