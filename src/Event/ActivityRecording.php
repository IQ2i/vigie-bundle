...
/**
 * Dispatched by ActivityRecorder right before an activity is stored, after
 * `record.*` redaction has already run. A listener can enrich the
 * activity's context with business data, or veto the recording with
 * cancel(). Vetoing does not stop propagation: every listener still runs.
 */
