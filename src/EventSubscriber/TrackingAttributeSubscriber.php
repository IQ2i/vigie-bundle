...
/**
 * Reads #[Track]/#[Untrack] off the resolved controller and stamps the
 * verdict, the action and the subject on request attributes read back by
 * HttpActivitySubscriber. Uses its own reflection instead of
 * ControllerEvent::getAttributes(), which merges class and method
 * attributes without telling them apart.
 */
