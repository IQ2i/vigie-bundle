...
interface ThreatDecisionStoreInterface
{
    ...
    /**
     * Drops every decision of $provider and its last sync time, the "startup" resync path.
     */
    ...
    /**
     * Deletes decisions whose expiresAt is at or before $now, and returns
     * the total number deleted.
     */
