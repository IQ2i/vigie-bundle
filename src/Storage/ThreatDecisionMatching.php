...
/**
 * ThreatDecisionQuery filtering logic shared by InMemoryThreatDecisionStore and CacheThreatDecisionStore.
 *
 * @internal
 */
trait ThreatDecisionMatching
{
    ...
    {
        // Only Ip/Range scopes are ever matched by address.
