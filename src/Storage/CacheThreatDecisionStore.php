 ...
 * already has. A provider's decisions and its last sync time live in a
 * single cache item; find()/count() load the whole set and filter it in PHP.
 *
 * @internal
 */
